...
/* Defines ================================================================== */
/* RA-02 GPIO Defines */
#define BSP_LORA_CS GPIO_BIND(TRX_SPI_CS)
#define BSP_LORA_DIO0 GPIO_BIND(TRX_DIO0)
#define BSP_LORA_RESET GPIO_BIND(TRX_RESET)
...
/* Macros =================================================================== */
#define BSP_PULSE_I2C(__board) &__board.i2c_pulse
#define BSP_ACCEL_I2C(__board) &__board.i2c_accel
...
typedef struct {
  ...
  /** I2C Handle for MAX30100 */
  i2c_t i2c_pulse;

  /** I2C Handle for MPU6050 */
  i2c_t i2c_accel;
